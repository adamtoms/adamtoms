...
$WG_config['id_user']    = 188355; // YOUR WINDGURU USER ID (IF YOU DO NOT REMEMBER YOUR ID, SEE YOUR SETTINGS PAGE ON WINDGURU.CZ)
...
$WG_config['encoding']    = 'UTF-8'; // YOUR WEBPAGE ENCODING, FOR EXAMPLE 'UTF-8' ...
